...
2. Submit the request via mac10 CLI (coordinator handles routing + persistence)

```bash
mac10 request "[clear description of what the user wants]"
```
...
**Action:**
1. Create fix task via mac10 CLI (URGENT priority)
2. Add lesson to knowledge/mistakes.md
3. Signal Master-3

**Step 1 - Create fix task:**
```bash
mac10 fix "FIX worker-N: [brief description of what needs fixing]"
```
